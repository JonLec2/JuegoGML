...
function preload() {
    ...
    myFont=loadFont("Fortnite.ttf")
    tiroarco=loadSound("Tiro_con_arco.mp3")
    choque=loadSound("008842109_prev.mp3")
    choque1=loadSound("choque.mp3")
...
textSize(18)
text("Consigue a maxima cantidad de puntos tienes 5 intentos", 30, 50)
text("Lleva la flecha a tu arco presionando espacio", 30, 70)
...
if(gameState=="end"){
    ...
    fill(0, 125, 368)
    textFont(myFont)
    text("GameOver" , 480, 250)
    textSize(36)
    text("¡Intentalo de nuevo!" , 480, 300)
